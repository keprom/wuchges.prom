...
РНН организации <input name=rnn value='<?php echo trim($org_info->rnn); ?>'><br>
ИИК организации <input name=IIK value='<?php echo $org_info->IIK; ?>'><br>
Адрес организации <input name=address value='<?php echo trim($org_info->address); ?>'><br>
Телефон <input name=telefon value='<?php echo trim($org_info->telefon); ?>'><br>
Банк <input name=bank_name value='<?php echo trim($org_info->bank_name); ?>'><br>
...
Директор <input name=director value='<?php echo trim($org_info->director); ?>'><br>
Главный бухгалтер <input name=glav_buh value='<?php echo trim($org_info->glav_buh); ?>'><br>
Бухгалтер ЩГЭС <input name=buh value='<?php echo $org_info->buh; ?>'><br>
Начальник отдела сбыта <input name=nachalnik_otdela_sbyta value='<?php echo $org_info->nachalnik_otdela_sbyta; ?>'><br>
Cвидетельство о ндс <input name=svidetelstvo_nds value='<?php echo $org_info->svidetelstvo_nds; ?>'><br>
<br/><br/>
