...
<table width=100% border=1px cellspacing=0px style="border: black;font-family: Verdana; font-size: x-small;">
    ...
    <?php $i = 0;
    foreach ($counters->result() as $counter): ?>

        <?php if ($counter->counter_type_id != $last_type): ?>
            <tr>
                <td colspan=9><b><?php echo $counter->counter_type_name;
                        $last_ture = -1; ?></b></td>
            </tr>
        <?php endif; ?>
        ...
        <?php $last_ture = $counter->ture_id;
        $last_type = $counter->counter_type_id; endforeach; ?>
</table>
</html>