...
<table width=100%>
    ...
    <tr>
        <td align=left> Договор(контракт) на поставку товаров (работ, услуг)
    ...
    <tr>
        <td align=left> Пункт назначения поставляемых товаров (работ, услуг) <u><?php echo $firm->edit2; ?></u>_________________________
        </td>
        </td>
        <td> (4)</td>
    </tr>
    <tr>
        <td align=right><FONT size=1>(государство, регион, область, город, район)</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </td>
        <td></td>
    </tr>
    <tr>
        <td align=left> Поставка товаров осуществлена по доверенности №<u><?php echo $firm->edit3; ?></u>__________________________
        </td>
        <td> (5)</td>
    </tr>
    <tr>
        <td align=left> Способ отправления <u><?php echo $firm->edit4; ?></u>________________________________________________________
        </td>
        <td> (6)</td>
    </tr>
    <tr>
        <td align=left> Грузоотправитель <u><?php echo $firm->edit5; ?></u>__________________________________________________________
        </td>
        <td> (7)</td>
    </tr>
    <tr>
        <td align=left> Грузополучатель <u><?php echo $firm->edit6; ?></u>___________________________________________________________
        </td>
        <td> (8)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td align=left> РНН и адрес покупателя &nbsp;<u><?php echo $firm->rnn; ?></u> &nbsp;&nbsp;&nbsp;
            <u><?php echo $firm->address; ?></u></td>
        <td> (8б)</td>
    </tr>
    <tr>
        <td align=left> ИИК покупателя: <?php echo $firm->raschetnyy_schet; ?>
            в <?php echo $bank->name . " <br> БИК  " . $bank->mfo; ?>
