...
<table cellSpacing=0 border=1 width=100%>
    <TR>
        ...
        <TD vAlign=center align=middle <?php if ($full == 'true') echo "rowspan=2"; ?>><FONT size=2>Наименование
                материалов
            </FONT>
    ...
    $sum = 0;
    $i = 1;
    for ($j = 0; $j < $tariff_count; $j++): if ($tariff_kvt[$j] == 0) continue; ?>
