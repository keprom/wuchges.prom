...
<table width=100%>
    <tr>
        <td align=left>
            <center><b>СЧЕТ<?php if ($schet3 == "ОПЛАТЫ") {
                        echo " ";
                    } else echo $schet; ?> </b>
    ...
    <tr>
        <td width=2100px> ИИК поставщика <u><?php echo $org->IIK; ?> КБЕ-<?php echo $org->Bank_kbe; ?>
    ...
    <tr>
        <td width=2100px> Договор(контракт) на поставку товаров (работ, услуг) №<u><?php if ($firm->dog_real == '') {
    ...
    <tr>
        <td width=2100px> БИН и адрес местонахождения получателя <u><?php echo $firm->bin . " " . $firm->address; ?></u>
        </td>
        <td> (10а)</td>
    </tr>
    <tr>
        <td width=2100px> ИИК получателя <u><?php echo $firm->raschetnyy_schet; ?></u> в банке
...
<table cellSpacing=0 border=1>
    ...
    <TR>
        ...
        <TD vAlign=center align=middle><FONT size=1>Электроэнергия
                за <?php echo datetostring2($schetfactura_date->date); ?></FONT>
