...
<center>
    <table>
        <tr>
            <td><u>Директор <?php nbsp(3);
                    echo $org_info->director;
                    nbsp(17); ?></u></td>
            <td width=70px></td>
        ...
        <tr>
            <td style="border: black;font-family: Verdana; font-size: xx-small;">
                <center>(Должность, ФИО, подпись)</center>
            </td>
            <td width=70px></td>
            <td style="border: black;font-family: Verdana; font-size: xx-small;">
                <center>(Должность, ФИО, подпись)</center>
        ...
        <tr>
            <td><u>Гл. бухгалтер <?php nbsp(3);
                    echo $org_info->glav_buh;
                    nbsp(27); ?></u></td>
            <td width=70px></td>
