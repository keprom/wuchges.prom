    ...
    <table width=100%>
        <tr align=center>
            <td width=2100px>
                <b><?php echo(strlen(trim($akt_vypolnenyh_rabot)) == 0 ? "Есеп шот фактура / Счет-фактура" : $akt_vypolnenyh_rabot); ?>
                    №</b> <?php echo '0' . $schetfactura_date->schet_new . ' от ';
        ...
        <tr>
            <td width=2100px>Тауарлар (жұмыстар, қызметтер) жеткізуге арналған шарт (келісім-шарт)<br/>Договор(контракт)
                на поставку товаров (работ, услуг) №<u>   <?php if ($dog_real == '') {
        ...
        <tr>
            <td width=2100px>Жүк алушы <br/>Грузополучатель
                <u>  <?php echo $edit6; ?>                                                                                                                   </u>
            </td>
            <td> (9)</td>
        </tr>
        ...
        <tr>
            <td width=2100px>Сатып алушының БСН<br/>БИН и адрес нахождения покупателя
                <u> <?php echo "БИН " . $firm->bin . ", РНН " . $firm->rnn . ", " . $firm->address; ?></u></td>
        </tr>
        <tr>
