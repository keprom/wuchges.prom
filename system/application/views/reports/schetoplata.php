...
<body>
 <table width=100% >
 <tr>
  <td align=left> <center><b>СЧЕТ<?php if ($schet3=="ОПЛАТЫ") {echo " ";} else echo $schet;?> </b>
<?php echo ($schetfactura_date->schet_new>99999?'0':'').$schetfactura_date->schet_new.' от ';
if (strlen($data_schet)==0){ echo datetostring($schetfactura_date->date);} else { echo $data_schet;}?>
 ...
 <tr>
 <td width=2100px> ИИК поставщика <u><?php echo $org->IIK;?> КБЕ-<?php echo $org->Bank_kbe;?> КНП-<?php echo $org->bank_knp;?> <?php echo $org->bank_name; ?>              
 ...
 <tr>
 <td width=2100px> Договор(контракт) на поставку товаров (работ, услуг) №<u><?php if ($firm->dog_real=='') {echo $firm->dogovor."   </u> от <u>    ".datetostring($firm->dogovor_date);} else {echo $firm->dog_real;}?>                 </u></td>
 <td> (3)</td>
 </tr>
 <tr>
 ...
 <tr>
 <td width=2100px> БИН и адрес местонахождения получателя   <u><?php echo $firm->bin." ".$firm->address; ?></u></td>
 <td> (10а)</td>
 </tr>
 <tr>
 <td width=2100px> ИИК получателя <u><?php echo $firm->raschetnyy_schet;?></u> в банке <u><?php echo $bank->name." БИК ".$bank->mfo;?></u></td>
 <td> (10б)</td>
 </tr>
 </table><br>
 ...
 <TR>
  ...
  <TR>
	...
	<TR>
		...
		<TD vAlign=center align=middle><FONT size=1>Электроэнергия за <?php echo datetostring2($schetfactura_date->date);?></FONT> 
