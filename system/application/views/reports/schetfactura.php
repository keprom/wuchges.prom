...
<FONT size=7>
 <table width=100%>
 <tr align=center>
 <td width=2100px> <b><?php 
//if (isset($akt_vypolnenyh_rabot)){echo strlen(trim($akt_vypolnenyh_rabot));}else{echo "СЧЕТ-ФАКТУРА";}
echo (strlen(trim($akt_vypolnenyh_rabot))==0?$nakladnaya:$akt_vypolnenyh_rabot);//
...
if (strlen($data_schet)==0){ echo datetostring($schetfactura_date->date);} else { echo $data_schet;}?>
 ...
 <tr>
 <td width=2100px> ИИК получателя <u><?php echo $firm->raschetnyy_schet;?></u> в банке <u><?php echo $bank->name;?></u> БИК <u><?php echo $bank->mfo;?></u></td>
 <td> (10б)</td>
 </tr>
 </table>
 <br>
