...
<center><b> <?php echo $org_info->org_name; ?> Щучинские городские электросети <br> Отчет по оплате за электроэнергию и
        по задолжностям групп потребителей <br> за <?php echo $period->name; ?>.</b></center>
<br>
<br>
