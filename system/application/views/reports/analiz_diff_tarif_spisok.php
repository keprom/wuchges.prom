...
<table width=100% border=1px cellspacing=0px style="border: black;font-family: Verdana; font-size: x-small;">
    <tr align=center>
        ...
        <td rowspan=3 width=110px>По ср. отпускному тарифу (без НДС: 18.54)
        </td>
    ...
    <tr align=center>
        <td colspan=2>
            По тарифу дневной (18.54)
        </td>
        <td colspan=2>
            По тарифу ночной (7.36)
        </td>
        <td colspan=2>
            По тарифу вечерний (42.71)
        </td>
    </tr>
    <tr>
        <td>
...
//!
        ...
        $sum_otp_nds += ($d->itogo_kvt_day + $d->itogo_kvt_night + $d->itogo_kvt_evening) * 16.00;
        ...
        $_sum_otp_nds += ($d->itogo_kvt_day + $d->itogo_kvt_night + $d->itogo_kvt_evening) * 16.00;
        ...
        <tr align=right>
            ...
            <td>
                <?php echo f_d(($d->itogo_kvt_day + $d->itogo_kvt_night + $d->itogo_kvt_evening) * 16.00); ?>
            </td>

            <td>
                <?php echo f_d(($d->tenge_day + $d->tenge_night + $d->tenge_evening) - (($d->itogo_kvt_day + $d->itogo_kvt_night + $d->itogo_kvt_evening) * 16.00)); ?>
            </td>
