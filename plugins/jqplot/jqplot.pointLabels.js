...
(function ($) {
    ...
    $.jqplot.PointLabels.draw = function (sctx, options) {
        ...
        if (p.show) {
            ...
            switch (p.location) {
                case 'nw':
                    xoffset = function (elem) {
                        return -elem.outerWidth(true) - p.xpadding;
                    };
                    yoffset = function (elem) {
                        return -elem.outerHeight(true) - p.ypadding;
                    };
                    break;
                case 'n':
                    xoffset = function (elem) {
                        return -elem.outerWidth(true) / 2;
                    };
                    yoffset = function (elem) {
                        return -elem.outerHeight(true) - p.ypadding;
                    };
                ...
                case 'e':
                    ...
                    yoffset = function (elem) {
                        return -elem.outerHeight(true) / 2;
                    };
                    break;
                case 'se':
                    xoffset = function (elem) {
